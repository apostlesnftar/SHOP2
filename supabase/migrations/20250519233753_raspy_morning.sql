/*
  ...
  1. Changes
    - Update process_friend_payment function to accept any valid payment method
    - Add support for acacia_pay and other payment methods
    - Improve error handling and validation
*/

-- Update process_friend_payment function to handle more payment methods
