/*
  ...
  1. New Functions
    - `get_agent_team_order_stats`: Calculates order statistics for an agent and their entire team
      - Includes total orders, processing orders, and completed orders
      - Calculates total amounts for each category
      - Handles nested team structures (multi-level)
  
  2. Security
    - Function is accessible to authenticated users only
    - Validates that the user is an agent
    - Properly handles permissions and data access
*/
