/*
  ...
  1. New Functions
    ...
    - get_agent_processing_orders_stats - Get processing orders statistics for an agent and team
    
  2. Features
    - Tracks orders across multi-level team structures (up to 5 levels deep)
    - Calculates processing orders count and amount
    - Provides total orders, completed orders, and team size metrics
    - Supports commission calculation based on agent rates
*/
...
-- Function to get overall processing orders statistics for admin dashboard
...
DECLARE
  ...
  v_total numeric(10,2);
BEGIN
  -- Get count and total amount of all processing orders
  SELECT 
    COUNT(*),
