/*
  # Add Agent Network Functions
  
  1. New Functions
    - `get_agent_team_members` - Gets all team members for an agent (direct and indirect)
...
BEGIN
  ...
  v_team_size := array_length(v_team_member_ids, 1) - 1;
