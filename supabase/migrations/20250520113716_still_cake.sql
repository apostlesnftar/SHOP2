/*
  # Fix Agent Network Functionality
  
  1. New Functions
    - `get_agent_team_members` - Retrieves all team members for a specific agent
    - `get_agent_team_stats` - Provides comprehensive statistics for an agent's team
    - `get_agent_commission_summary` - Retrieves commission information for an agent
