/*
  # Fix Agent Team Members Function and Add Direct User Creation
  
  1. Changes
    - Fix ambiguous user_id column reference in get_agent_team_members function
    - Add create_team_member function for agents to create users directly with passwords
    - Improve team member creation with proper parent-child relationship
  
  2. Security
    - Ensure proper validation of inputs
    - Maintain security with SECURITY DEFINER
    - Set appropriate permission grants
*/
