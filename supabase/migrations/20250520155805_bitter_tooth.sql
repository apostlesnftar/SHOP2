/*
  # Fix Agent Referral System
  
  1. Changes
    - Update handle_user_registration_with_referral to set referred users as customers
    - Create new functions for team member queries that include referred customers
    - Fix team statistics calculation to include both agents and referred customers
    - Ensure proper parent-child relationships in the agent network
  
  2. Security
    - Maintain existing security context
    - Ensure proper access control for all functions
*/
