/*
  # Add Customer Order Stats Function
  
  1. New Functions
    - `get_customer_order_stats` - Get order statistics for a customer including shared orders
    - `handle_shared_order_payment_completion` - Updated to calculate commissions for shared orders
