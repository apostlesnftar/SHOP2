/*
  # Fix Agent Commission Summary Function
  
  1. Changes
    - Drop existing function first to change return type from JSONB to JSON
    - Recreate function with proper aggregation for recent commissions
    - Fix the GROUP BY issue with created_at column
  
  2. Security
    - Maintain SECURITY DEFINER to ensure proper access control
    - Ensure proper validation of agent status
*/

-- First drop the existing function to change the return type
