/*
  # Fix ambiguous ID column in get_agent_wallet_transactions function
  
  1. Changes
    - Update get_agent_wallet_transactions function to explicitly qualify the id column
    - Fix the "column reference id is ambiguous" error
    - Ensure proper table aliases are used for all column references
*/
