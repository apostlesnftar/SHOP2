...
-- Recreate the function with case-insensitive payment method validation
...
BEGIN
  ...
  RAISE LOG 'Processing payment with method: %', p_payment_method;
  ...
  IF v_so_order_number IS NULL THEN
    SELECT o.order_number INTO v_so_order_number
    FROM orders o
