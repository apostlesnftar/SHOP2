/*
  # Add Test Payment Support
  
  1. Changes
    - Update process_friend_payment function to handle 'test' payment method
    - Add special case to bypass payment processing for test payments
    - Maintain all existing functionality for other payment methods
*/

-- Drop the existing function if it exists
DROP FUNCTION IF EXISTS process_friend_payment(p_share_id text, p_payment_method text);

-- Recreate the function with test payment support
